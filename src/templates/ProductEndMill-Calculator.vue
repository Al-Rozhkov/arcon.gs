    ...
    <main class="container">
      ...
      <div>
        ...
        >
          <b-form-select id="js-form-usage" v-model="formUsage">
            ...
            <b-form-select-option-group label="Возможное применение">
              <b-form-select-option
                v-for="item in $page.series.possibleUsage"
                :key="item.id"
                :value="item.id"
              >
                {{ item.text }}
        ...
        <b-form-group
          label="Тип обработки"
          label-cols="auto"
          label-for="js-form-processing-type"
        >
          <b-form-radio-group
            id="js-form-usage"
            v-model="formProcessingType"
            buttons
            button-variant="outline-secondary"
            name="js-form-processing-type"
          >
        ...
        <!-- Диаметр инструмента -->
        <b-form-group
          label="Диаметр инструмента (D)"
          label-cols="auto"
          label-for="js-form-diameter"
        >
          <b-input-group append="мм.">
            <b-form-input
              v-model="formDiameter"
              name="js-form-diameter"
              type="number"
              min="0.01"
              step="0.01"
            />
        ...
        <!-- Количество зубьев -->
        <b-form-group
          label="Количество зубьев (Z)"
          label-cols="auto"
          label-for="js-cogs-number"
        >
          <b-input-group append="шт.">
            <b-form-input
              v-model="formCogsNumber"
              name="js-cogs-number"
              type="number"
              min="1"
              step="1"
        ...
        <!-- Скорость резания -->
        <b-form-group
          label="Скорость резания (Vc)"
          label-cols="auto"
          label-for="js-cutting-speed"
        >
          <b-input-group append="м/мин">
            <b-form-input
              v-model="formCuttingSpeed"
              name="js-cutting-speed"
              type="number"
              min="1"
              step="1"
            />
        ...
        <!-- Частота вращения -->
        <b-form-group
          label="Частота вращения (n)"
          label-cols="auto"
          label-for="js-rotational-speed"
        >
          <b-input-group append="об/мин">
            <b-form-input
              v-model="formRotationalSpeed"
              name="js-rotational-speed"
              type="number"
              min="1"
              step="1"
            />
        ...
        <!-- Минутная подача -->
        <b-form-group
          label="Минутная подача (fv)"
          label-cols="auto"
          label-for="js-minute-pitch"
        >
          <b-input-group append="мм/мин">
            <b-form-input
              v-model="formMinutePitch"
              name="js-minute-pitch"
              type="number"
              min="1"
              step="1"
            />
        ...
        <!-- Подача на оборот -->
        <b-form-group
          label="Подача на оборот (fn)"
          label-cols="auto"
          label-for="js-pitch-per-turn"
        >
          <b-input-group append="мм/об">
            <b-form-input
              v-model="formPitchPerTurn"
              name="js-minute-pitch"
              type="number"
              min="0.001"
              step="0.001"
        ...
        <!-- Подача на зуб -->
        <b-form-group
          label="Подача на зуб (fz)"
          label-cols="auto"
          label-for="js-pitch-per-cog"
        >
          <b-input-group append="мм/зуб">
            <b-form-input
              v-model="formPitchPerCog"
              name="js-minute-cog"
              type="number"
              min="0.001"
              step="0.001"
        ...
        <!-- Глубина резания -->
        <b-form-group
          label="Глубина резания (ap)"
          label-cols="auto"
          label-for="js-form-cutting-depth"
        >
          <b-input-group append="мм.">
            <b-form-input
              v-model="formCuttingDepth"
              name="js-form-cutting-depth"
              type="number"
              min="0.01"
              step="0.01"
            />
        ...
        <!-- Ширина резания -->
        <b-form-group
          label="Ширина резания (ae)"
          label-cols="auto"
          label-for="js-form-cutting-width"
        >
          <b-input-group append="мм.">
            <b-form-input
        ...
        <!-- Длина обработки -->
        <b-form-group
          label="Длина обработки (l)"
          label-cols="auto"
          label-for="js-form-processing-length"
        >
          <b-input-group append="мм.">
            <b-form-input
              v-model="formProcessingLength"
              name="js-form-processing-length"
              type="number"
              min="0.01"
              step="0.01"
            />
        ...
        <!-- Время обработки -->
        <b-form-group
          label="Время обработки (t)"
          label-cols="auto"
          label-for="js-form-processing-time"
        >
          <b-input-group append="мин.">
            <b-form-input
              :value="formProcessingTime"
              name="js-form-processing-time"
              type="number"
              disabled
            />
          </b-input-group>
