<template>
  <Layout>
    <main class="cnt">
      ...
      <section>
        <arconit-logos height="70" class="arconit-logo" />
      </section>
      ...
      <p>
        ...
        <a href="/uploads/Arconit-russian_produced.pdf">(Скачать письмо-заявление)</a>.
      </p>
...
<script>
import ArconitLogos from '@/components/ArconitLogos.vue'
