...
Настоящие Положение о политике конфиденциальности (далее — Положение) является официальным документом ООО «Центр высокоточной механообработки «Аркон» (далее — Оператор), и определяет порядок обработки и защиты информации о физических лицах (далее — Пользователи), пользующихся сервисами, информацией и услугами на доменном имени **www.cvm-arcon.ru** и **www.arconit** (далее — Сайт).
